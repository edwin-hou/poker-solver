...
| Hungry Horse treats charts as a baseline that moves with opponent quality, position, depth, sizing, rake, and players left to act. | First-in raising widens by seat (about 9% UTG, 14% HJ, 19% CO, and 31% BTN) while weaker entered hands remain limps rather than turning the archetype into a LAG. Low Ax, small pairs, and connectors use deterministic combo splits rather than pure opens. |
...
| Hand2Note's 41,000-hand passive-fish aggregate 3-bet only 2.1% overall, yet its observed reraise hands included 77–TT, ATo, A4s, and J6s. | TT and KQs receive small exact-combo 3-bet slices that expand versus late opens and dead money and shrink versus large early opens; most combinations remain calls. |
